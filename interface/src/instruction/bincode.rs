//! `bincode` implementation of the instruction helpers.
...
fn initialize_account<T: Default + Serialize>(config_pubkey: &Pubkey) -> Instruction {
...
pub fn create_account_with_max_config_space<T: Default + Serialize>(
